...
By default, the edmdata executable will:
- Pull recent data from the https://developer.parliament.uk APIs.
- Collect that data into mongodb.
- Create JSON files and SVG/PNG graphs of Early Day Motion statistics, based on the data.
...
To run the tool, execute the following set of commands, from the root of `edmdata`:
- `docker run --rm -d -v ./data/db:/data/db -p 27017:27017 mongo`
- `cargo r -r`
